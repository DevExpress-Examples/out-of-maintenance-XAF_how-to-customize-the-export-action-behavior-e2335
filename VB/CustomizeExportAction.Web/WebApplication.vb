...
Namespace CustomizeExportAction.Web
   Partial Public Class CustomizeExportActionAspNetApplication
      ...
      Private Sub CustomizeExportActionAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
      End Sub
